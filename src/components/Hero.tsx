...
const Hero = () => {
  ...
  useEffect(() => {
    // Inicia a animação do texto um pouco depois do componente ser montado
    const timer = setTimeout(() => {
      setStartAnimations(true);
    }, 100); // Pequeno delay para garantir uma transição suave
      ...
      <div className="container-max">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 fade-in">
            ...
            <p className="text-xl lg:text-2xl text-muted-foreground leading-relaxed slide-top" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <GridHoverButton
                href="https://wa.me/5551989354834?text=Olá Guilherme, bom dia! Vim aqui pelo seu portfóli, será que podemos conversar?"
                target="_blank"
            ...
            <div className="flex items-center space-x-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group text-muted-foreground hover:text-primary transition-colors duration-300 slide-top"
                style={{ animationDelay: '0.5s' }}
              >
                <svg className="w-6 h-6 group-hover:animate-rotate-hor-center" fill="currentColor" viewBox="0 0 24 24">
