      ...
      <div className="container-max py-12 px-4">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-md">
              Desenvolvedor Full-Stack especializado em IA, criando soluções digitais
              que transformam ideias em resultados mensuráveis.
            </p>
        ...
        <div className="border-t border-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm">
            © {currentYear} Guilherme Roesler. Todos os direitos reservados.
          </p>
