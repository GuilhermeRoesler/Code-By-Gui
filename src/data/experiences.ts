export const experiences = [
    {
        ...
        company: "Hospital Municipal Getúlio Vargas – Sapucaia do Sul",
        period: "2024–2025",
        achievements: [
            "Acesso remoto seguro à intranet, facilitando o trabalho híbrido.",
            "Aumento da eficiência operacional de equipes administrativas e clínicas.",
            "Melhoria da manutenibilidade e escalabilidade do código."
        ],
        description: "Atuei no desenvolvimento e modernização de sistemas internos hospitalares, com foco na migração da intranet para uma nova arquitetura React + TypeScript, permitindo acesso remoto seguro e redução de tempo de resposta em processos administrativos."
    }
    // {
